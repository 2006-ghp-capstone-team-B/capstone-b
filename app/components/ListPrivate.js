    ...
    return (
      <ListItem icon>
        ...
        <Right style={{ width: "35%" }}>
          <Button style={globalStyles.buttonMini} transparent onPress={() => increase(item.userId, item.listId, item.itemId, item.quantity)}>
            <Text>+</Text>
          </Button>
          <Button style={globalStyles.buttonMini} transparent onPress={() => decrease(item.userId, item.listId, item.itemId, item.quantity)}>
            <Text>-</Text>
          </Button>
