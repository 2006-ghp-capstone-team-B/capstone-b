        ...
        <ScrollView>
          <View style={{ justifyContent: "center" }}>
            ...
            <View >
              ...
              {searchErr
            ? <Text note style={{color: 'red', alignSelf: 'center', width: '90%'}}>You did not search for a valid Household Id. Please enter a different Id and try again.</Text>
            : null}
            </View>
              ...
              ?  <View style={{
                ...
                alignContent: 'center'
                  ...
                  <Text note numberOfLines={1} style={{alignSelf: 'center'}}>Household Id: {listId}</Text>
                  </View>
